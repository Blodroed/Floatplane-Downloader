...
![image](https://user-images.githubusercontent.com/6373693/115112327-2b69b680-9fd9-11eb-8239-45b30219f705.png)  
...
## Binaries
1. Download the latest binary for your OS from **[Releases](https://github.com/Inrixia/Floatplane-PlexDownloader/releases)** 
...
## Unraid
Go install it using the [**unraid template**](https://unraid.net/community/apps?q=floatplane#r)!
...
For further customization please read the
### **[Settings Wiki](https://github.com/Inrixia/Floatplane-Downloader/blob/master/wiki/settings.md)**
